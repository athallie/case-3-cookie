...
<body>
    <div class="container-fluid" id="main-container">
        <div class="card shadow align-items-center" id="login-container">
            <div class="card-body">
                <h1 class="card-title container-fluid text-center">Login</h1>
                <form class="container-fluid" id="login-form">
                    ...
                    <div class="form-check small" id="checkbox">
                        ...
                        <label class="form-check-label small" for="login-checkbox">Remember Me</label>
                    </div>
                    <div class="row">
    ...
    <script src="/scripts/js/login-page.js"></script>
</body>
</html>
